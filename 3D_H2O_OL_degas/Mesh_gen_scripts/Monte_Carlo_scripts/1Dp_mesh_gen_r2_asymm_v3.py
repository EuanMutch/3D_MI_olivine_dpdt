...
dist_a_centre_pve = df_f['MI_centre_a_dist_pve'].values[0]
dist_a_centre_nve = df_f['MI_centre_a_dist_nve'].values[0]
...
fc_nve_x = df_f['Face_nve_x'].values[0]
fc_nve_y = df_f['Face_nve_y'].values[0]
fc_nve_z = df_f['Face_nve_z'].values[0]
...
mi_b3 = geom.add_point([mi_x - mi_r, mi_y - pl_th, mi_z], mesh_hres)
mi_b4 = geom.add_point([mi_x - mi_r, mi_y + pl_th, mi_z], mesh_hres)
...
ol_e3 = geom.add_point([fc_nve_x, fc_nve_y - pl_th, fc_nve_z], mesh_lres)
ol_e4 = geom.add_point([fc_nve_x, fc_nve_y + pl_th, fc_nve_z], mesh_lres)


# Add lines joining points - melt inclusion
# mi
mi_l1 = geom.add_line(mi_b1, mi_b2)
mi_l2 = geom.add_line(mi_b2, mi_b3)
mi_l3 = geom.add_line(mi_b3, mi_b4)
mi_l4 = geom.add_line(mi_b4, mi_b1)
...
ol_l4 = geom.add_line(mi_b4, ol_e4)
ol_l5 = geom.add_line(ol_e4, ol_e3)
ol_l6 = geom.add_line(ol_e3, mi_b3)

mi_ll1 = geom.add_line_loop([mi_l1, mi_l2, mi_l3, mi_l4])
mi_s1 = geom.add_plane_surface(mi_ll1, holes=None)

ol_ll1 = geom.add_line_loop([mi_l1, ol_l1, ol_l2, ol_l3])
ol_s1 = geom.add_plane_surface(ol_ll1, holes=None)

ol_ll2 = geom.add_line_loop([mi_l3, ol_l4, ol_l5, ol_l6])
ol_s2 = geom.add_plane_surface(ol_ll2, holes=None)

# melt inclusion

mi_ps1 = geom.add_physical(mi_l1)
mi_ps2 = geom.add_physical(mi_l3)
mi_pv = geom.add_physical(mi_s1)

ol_ps1 = geom.add_physical(ol_l2)
ol_pv1 = geom.add_physical(ol_s1)

ol_ps2 = geom.add_physical(ol_l5)
ol_pv2 = geom.add_physical(ol_s2)
...
geom.add_raw_code('Field[1].EdgesList = {l0, l2};') # mi_l1, mi_l3
